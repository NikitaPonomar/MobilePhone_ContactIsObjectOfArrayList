# MobilePhone_ContactIsObjectOfArrayList
Simple phone book with only 2 fields: Name and Phone number. The folowing technics were used: fabric method, ArrayList of Objects, Incapsulation, printMenu, user input validation
